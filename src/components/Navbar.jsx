...
const Navbar = () => {
  // const currentUser={displayName:"Cihat"};
  const currentUser=false
  return <>
  <nav className=" w-full flex flex-wrap items-center justify-between text-white py-3 bg-gray-900  shadow-lg navbar navbar-expand-lg fixed-top">
